...
export class PasswordGeneratorPanel {
    public static currentPanel: PasswordGeneratorPanel | undefined;
    public static readonly viewType = 'openvaultPasswordGenerator';
    ...
    public static createOrShow(extensionUri: vscode.Uri) {
        ...
        const panel = vscode.window.createWebviewPanel(
            PasswordGeneratorPanel.viewType,
            'OpenVault Password Generator',
            ...
            async message => {
                switch (message.command) {
                    case 'copyPassword':
                        ...
                        return;
                    case 'showQR':
                        const { QRCodePanel } = await import('./qrCodePanel');
